            ...
            return es.map((file, cb) => {
                ...
                gulp.src(file.path)
                    ...
                    .pipe(gulpif(
                        ...
                        inject(gulp.src([`./tmp/static/js/**/assign*-${cateName}*.js`, `./tmp/static/css/**/${cateName}.css`, `./tmp/static/js/**/${cateName}.js`, `./tmp/static/css/**/*-${cateName}.css`, `./tmp/static/js/**/*-${cateName}.js`], {
                            read: false
                        }), {
